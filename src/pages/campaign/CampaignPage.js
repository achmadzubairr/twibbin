          ...
          <div className="mt-6 bg-white w-[18rem] md:w-[28rem] lg:w-[35rem] drop-shadow-lg rounded-lg p-4">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
              ...
              <button
                ...
                onTouchStart={(e) => e.stopPropagation()}
                onTouchEnd={(e) => e.stopPropagation()}
                className="flex flex-col items-center p-3 bg-black bg-opacity-5 hover:bg-black hover:bg-opacity-10 rounded-lg transition-colors duration-200 border border-gray-300"
                style={{ touchAction: 'manipulation' }}
              >
                <svg className="w-8 h-8 mb-1" viewBox="0 0 24 24" fill="currentColor">
              ...
              >
                <svg className="w-8 h-8 mb-1" viewBox="0 0 24 24" fill="currentColor">
                  <path fill="#6B7280" d="M13.19 8.688a4.5 4.5 0 0 1 1.242 7.244l-4.5 4.5a4.5 4.5 0 0 1-6.364-6.364l1.757-1.757m13.35-.622 1.757-1.757a4.5 4.5 0 0 0-6.364-6.364l-4.5 4.5a4.5 4.5 0 0 0 1.242 7.244"/>
                </svg>
